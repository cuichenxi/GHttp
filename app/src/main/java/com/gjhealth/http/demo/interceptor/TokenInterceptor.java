package com.gjhealth.http.demo.interceptor;
...
import com.gjhealth.http.demo.model.LoginCache;
import com.gjhealth.http.demo.model.LoginInfo;
import com.gjhealth.http.demo.token.TokenManager;
import com.gjhealth.http.demo.utils.DateTimeUtils;
import com.gjhealth.http.demo.utils.MD5;
import com.gjhealth.http.exception.ApiException;
import com.gjhealth.http.interceptor.BaseExpiredInterceptor;
...
//                    case ComParamContact.Code.NO_ACCESS_TOKEN://缺少授权信息,没有accessToken,应该是没有登录
    ...
    public void refreshToken() throws IOException {
        GHttp.post(ComParamContact.Token.PATH)
...
//        originalResponse.body().close();
    ...
    private void reLogin() throws IOException {
        ...
        GHttp.post(ComParamContact.Login.PATH)
