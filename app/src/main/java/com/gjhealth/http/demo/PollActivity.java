...
public class PollActivity extends AppCompatActivity {
    ...
    protected void onDestroy() {
        GHttp.cancelSubscription(polldisposable);
        GHttp.cancelSubscription(countdisposable);
        GHttp.cancelSubscription(ifdisposable);
        GHttp.cancelSubscription(filterdisposable);
        super.onDestroy();
    }
