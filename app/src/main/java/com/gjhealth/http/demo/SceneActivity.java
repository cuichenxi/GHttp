...
import com.gjhealth.http.demo.customapi.test1.ResultBean;
import com.gjhealth.http.demo.customapi.test1.TestApiResult1;
import com.gjhealth.http.demo.customapi.test5.TestApiResult5;
import com.gjhealth.http.demo.customapi.test6.Content;
import com.gjhealth.http.demo.customapi.test6.TestApiResult6;
...
public class SceneActivity extends AppCompatActivity {
    ...
    public void onDeferredRequest(View view) {
        ...
        Observable.timer(5, TimeUnit.SECONDS).flatMap(new Function<Long, ObservableSource<SkinTestResult>>() {
            ...
            public ObservableSource<SkinTestResult> apply(@NonNull Long aLong) throws Exception {
                Log.i("test", "=====" + aLong);
                return GHttp.get("/v1/app/chairdressing/skinAnalyzePower/skinTestResult")
                        .timeStamp(true)
    ...
    public void onNestedRequest(View view) {
        ...
        Observable<AuthModel> login = GHttp.post(ComParamContact.Login.PATH)
    ...
    public void onZipRequest(View view) {
        ...
        //例如下面：数据来自3个不同的接口
        Observable<ResultBean> mobileObservable = GHttp.get("http://apis.juhe.cn/mobile/get")
        ...
        Observable<Content> searchObservable = GHttp.get("/ajax.php")
        ...
        Observable<List<SectionItem>> listObservable = GHttp.get("http://news-at.zhihu.com/api/3/sections")
    ...
    public void onMergeRequest(View view) {
        ...
        Observable<ResultBean> mobileObservable = Observable.timer(5, TimeUnit.SECONDS).flatMap(new Function<Long, ObservableSource<ResultBean>>() {
            ...
            public ObservableSource<ResultBean> apply(@NonNull Long aLong) throws Exception {
                return GHttp.get("http://apis.juhe.cn/mobile/get")
                        .params("phone", "18688994275")
                        .params("dtype", "json")
                        .params("key", "5682c1f44a7f486e40f9720d6c97ffe4")
                        .execute(new CallClazzProxy<TestApiResult1<ResultBean>, ResultBean>(ResultBean.class) {
