...
import com.gjhealth.http.cache.model.CacheResult;
import com.gjhealth.http.callback.CallBackProxy;
...
import com.gjhealth.http.demo.customapi.test2.Result;
import com.gjhealth.http.demo.customapi.test2.TestApiResult2;
import com.gjhealth.http.demo.customapi.test3.TestApiResult3;
import com.gjhealth.http.demo.customapi.test4.GwclBean;
import com.gjhealth.http.demo.customapi.test9.FriendsListBean;
import com.gjhealth.http.demo.customapi.test9.MyResult;
import com.gjhealth.http.demo.customapi.testN.HttpManager;
...
public class CustomApiActivity extends AppCompatActivity {
    ...
    public void onTestOne(View view){
        ...
        //方式二
        /* Observable<ResultBean> observable = GHttp.get("http://apis.juhe.cn/mobile/get")
                .readTimeOut(30 * 1000)//局部定义读超时
                .writeTimeOut(30 * 1000)
                .params("phone", "18688994275")
                .params("dtype", "json")
    ...
    public void onTestTwo(View view){
        ...
        GHttp.get("http://japi.juhe.cn/joke/content/list.from")
    ...
    public void onTestThree(View view){
        GHttp.post("http://xxx.xx.xx/dlydbg/api/user/login")
    ...
    public void onTestFive(View view){
        GHttp.get("https://api.91kaiteng.com/v1/user/Frineds")
