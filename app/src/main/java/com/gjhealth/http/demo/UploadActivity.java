...
import com.gjhealth.http.body.UIProgressResponseCallBack;
...
public class UploadActivity extends AppCompatActivity {
    ...
    public void onUploadFile(View view) throws Exception {
        ...
        GHttp.post("/v1/user/uploadAvatar")
    ...
    public void onUploadFileMaps(View view) {
        ...
        GHttp.post("AppYuFaKu/uploadHeadImg")
    ...
    public void onUploadFileMaps2(View view) {
        ...
        GHttp.post("http://106.14.83.28:89/index.php?s=/Home/user/dj_add_care")
                .params("uid", "1")
                .params("title", "冷小菜")
    ...
    public void onUploadOne(View view) {
        ...
        GHttp.post("index.php/Home/index/uploadImg")
