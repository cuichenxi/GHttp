...
import com.gjhealth.http.callback.DownloadProgressCallBack;
...
public class DownloadActivity extends AppCompatActivity {
    ...
    public void onDownloadFile1(View view) {//下载回调是在异步里处理的
        GHttp.downLoad("http://apk.hiapk.com/web/api.do?qt=8051&id=723")
        //GHttp.downLoad("http://crfiles2.he1ju.com/0/925096f8-f720-4aa5-86ae-ef30548d2fdc.txt")
