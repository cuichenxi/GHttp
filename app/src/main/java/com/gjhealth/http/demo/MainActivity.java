...
package com.gjhealth.http.demo;
...
import com.gjhealth.http.GHttp;
import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;
import com.gjhealth.http.callback.CallBack;
import com.gjhealth.http.callback.CallClazzProxy;
import com.gjhealth.http.callback.ProgressDialogCallBack;
import com.gjhealth.http.callback.SimpleCallBack;
import com.gjhealth.http.demo.Api.LoginService;
import com.gjhealth.http.demo.constant.AppConstant;
import com.gjhealth.http.demo.constant.ComParamContact;
import com.gjhealth.http.demo.customapi.test5.TestApiResult5;
import com.gjhealth.http.demo.model.ApiInfo;
import com.gjhealth.http.demo.model.AuthModel;
import com.gjhealth.http.demo.model.SectionItem;
import com.gjhealth.http.demo.model.SkinTestResult;
import com.gjhealth.http.demo.utils.FileUtils;
import com.gjhealth.http.demo.utils.MD5;
import com.gjhealth.http.exception.ApiException;
import com.gjhealth.http.model.ApiResult;
import com.gjhealth.http.request.CustomRequest;
import com.gjhealth.http.subsciber.BaseSubscriber;
import com.gjhealth.http.subsciber.IProgressDialog;
import com.gjhealth.http.subsciber.ProgressSubscriber;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onGet(View view) {
        GHttp.get("/v1/app/chairdressing/skinAnalyzePower/skinTestResult")
    ...
    public void onPost(View view) {
        GHttp.post("v1/app/chairdressing/news/favorite")
                .params("newsId", "552")
                .accessToken(true)
                .timeStamp(true)
                .execute(new SimpleCallBack<String>() {
    ...
    public void onPostObject(View view) {
        ...
        GHttp.post("client/shipper/getCarType")
    ...
    public void onPut(View view) {
        ...
        GHttp.put("http://api.youdui.org/api/v1/cart/1500996")
                .removeParam("appId")
                .params("count", "4")
                .execute(new SimpleCallBack<String>() {
                    @Override
    ...
    public void onDelete(View view) {
        ...
        GHttp.delete("https://www.xxx.com/v1/user/Frined")
    ...
    public void onCallBack(View view) {
        ...
        Disposable mDisposable = GHttp.get("/v1/app/chairdressing/skinAnalyzePower/skinTestResult")
                .timeStamp(true)
    ...
    public void onSubscription(View view) {
        Disposable disposable = GHttp.get("/v1/app/chairdressing/skinAnalyzePower/skinTestResult")
                .timeStamp(true)
                .execute(new SimpleCallBack<SkinTestResult>() {
        ...
        //GHttp.cancelSubscription(disposable);
    ...
    public void onObservable(View view) {
        Observable<SkinTestResult> observable = GHttp.get("/v1/app/chairdressing/skinAnalyzePower/skinTestResult")
                .timeStamp(true)
    ...
    public void onCustomCall(View view) {
        ...
        final CustomRequest request = GHttp.custom().addConverterFactory(GsonConverterFactory.create(new Gson()))
                .sign(true)
                .timeStamp(true)
        ...
        //GHttp.cancelSubscription(disposable);//取消订阅
    }

    public void onCustomApiCall(View view) {
        final String name = "18688994275";
        final String pass = "123456";
        final CustomRequest request = GHttp.custom()
    ...
    public void onListResult(View view) {
        //方式一：
       /* GHttp.get("http://news-at.zhihu.com/api/3/sections")
        ...
        //方式二：
        /*Observable<List<SectionItem>> observable = GHttp.get("http://news-at.zhihu.com/api/3/sections")
